...
public class tempo_2jugadores extends AppCompatActivity {

    private Button empezar, j1, j2, resul;
    private TextView j1p, j2p, textoRondas;
    ...
    private int puntosTotal1 = 0, puntosTotal2 = 0;
    ...
    //metodo que pausa o audio ao pulsar o boton de retroceso
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.juego2j);
        ...
        resul.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(tempo_2jugadores.this, Resultados2.class);
